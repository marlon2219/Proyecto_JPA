                ...
                <div class="row">
                    <div class="col-12 col-md-9">
                        ...
                        <div class="card-header">
                            <h4>Libros guardados por los usuarios</h4>
                        </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <c:forEach var="venta" items="${listadoV}" varStatus="status">
                                    <tr>
                                       
                                        <td>${venta.getUsuarios().getNombre()}</td>
                                        <td>${venta.getUsuarios().getCorreo()}</td>
                                        <td>${venta.getLibros().getTitulo()}</td>
                                        <td>${venta.getLibros().getPrecio()}</td>
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <div style="background-image: linear-gradient(-20deg, #fc6076 0%, #ff9a44 100%); border: none;" class="card text-center  text-white mb-3">
                            <div class="card-body">
                                ...
                                <h4 class="display-4">
                                    <i class="fas fa-users"></i> ${listadoV.size()}
