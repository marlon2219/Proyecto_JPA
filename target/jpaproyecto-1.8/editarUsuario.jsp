<html>
    ...
    <body>
        ...
        <div class="container mt-4">
            <form class="was-validate" action="AdminServlet?accion=modificarUsuario" method="POST">

                <input type="hidden" name="ide"  class="form-control" id="exampleInputEmail1" value="${usuarioEncontrado.idUsuario}"  >
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="telefono" class="form-control" id="exampleInputEmail1"  value="${usuarioEncontrado.telefono}"  >
                ...
                <section id="actions" class="py-4 mb-2">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="AdminServlet?accion=listarEmpleados" class="btn btn-danger  btn-block">
                                    VOLVER
                                </a>
