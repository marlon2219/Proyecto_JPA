                    ...
                    <div class="col-12 col-md-12 ">
                         <nav  style="float: right" class="navbar ">
                                <div class="container-fluid">
                                    <form action="AdminServlet" method="POST" class="d-flex">
                                        ...
                                        <button class="btn btn-outline-success" type="submit" name="accion" value="listarUsuariosBusqueda">Buscar/Todos</button>
                                    </form>
                                </div>
                            </nav>
                        <!--AKI LA TABLA-->
                        <div class="card-header">
                            <h4>Usuarios (${totalUsuarios})</h4>
                        </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                 ...
                                 <c:forEach var="usu" items="${usuarios}" varStatus="status">
                                    <tr>
                                        ...
                                        <td>${usu.getSaldo()}</td>                                        
                                        <td>
                                            <a href="AdminServlet?accion=editarUsuario&idUsuario=${usu.getIdUsuario()}" class="btn btn-outline-warning">
                                                <i class="fas fa-angle-double-right"></i> Editar
                                            </a>
                                            <a href="AdminServlet?accion=eliminarUsuario&idUsuario=${usu.getIdUsuario()}" class="btn btn-danger btn-block" ><i class="fas fa-trash"></i> Eliminar 
                                            </a>
                                        </td>
                                    ...
                                    <c:forEach var="usu" items="${resultadoo}" varStatus="status">
                                    <tr>
                                        <td>${status.count}</td> <!-- ceunta el numero de filas, otra forma de poner el id -->
                                        <td>${usu.getNombre()}</td>
                                        <td>${usu.getDni()}</td>
