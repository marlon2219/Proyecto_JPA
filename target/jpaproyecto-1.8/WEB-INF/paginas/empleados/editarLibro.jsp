...
<html>
    ...
    <body>
        ...
        <div class="container mt-4">
          <form class="was-validate" action="ControladorLibros?accion=modificar" method="POST">
              
                    <input type="hidden" name="ide"  class="form-control" id="exampleInputEmail1" value="${ideLibro}"  >
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" name="paginas" class="form-control" id="exampleInputEmail1"  value="${libroEncontrado.paginas}"  >
                  ...
                  <jsp:include page="/WEB-INF/paginas/comunes/botonesNavegacionEditarLibros.jsp" />  
                </form>
