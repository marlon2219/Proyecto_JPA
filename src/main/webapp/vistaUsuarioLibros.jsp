...
<html lang="en">
 ...
 <!-- **************************************HASTA AKI*********************************************************** -->
       ...
       <!-- FINAL DEL MODAL (SE PUEDE QUITAR SI FUNCION LAS DIRECCIONES DE LAS CARPETAS) -->
        ...
        <!--BODY-->
        <nav style="width:100%; height:5rem; border-top: 4px solid #FFFFFF;background-color: #F5B041" class="navbar navbar-light">
            <div class="container-fluid">
                <form style=" margin: auto;width: 50rem;height: 3rem" class="d-flex" action="LibroServlet" method="POST">
                    <input class="form-control me-2" name="busqueda" type="search" placeholder="titulo,autor,categoria" aria-label="Search">

                    <button style="margin-left:6px" class="btn btn-outline-success" type="submit" name="accion" value="buscar">Buscar/Todos</button>
                </form>
            ...
            <div class="row mt-5 ">
                ...
                <c:forEach var="libro" items="${libros}">
                    ...
                    <div  class="col-12 col-md-6  col-lg-4">
                        <div class="container mx-auto box">
                            <div class="card  " style="width: 25rem; margin: 10px auto; padding: 10px; ">
                                <div class="portadalibro">
                                    <h2 style="color: whitesmoke">${libro.getTitulo()}</h2>
                                </div>
                                <div class="card-body">
                                    <h5 class="card-title">Autor: ${libro.getAutor()} </h5>
                                    <p class="card-text">Categoria: ${libro.getGenero()}</p>
                                    <p class="card-text">N° Páginas: ${libro.getPagina()}</p>
                                    <p class="card-text">Precio: ${libro.getPrecio()} € <a style="float: right" href="LibroHasUsuariosServlet?accion=insertar&libro=${libro.getIdlibro()}&precioLibro=${libro.getPrecio()}" class="btn btn-danger mt-3">AÑADIR</a> </p>
                                </div>
                            </div>
                        </div>
                    </div>
