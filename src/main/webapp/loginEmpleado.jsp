    ...
    <body>
          ...
          <div class="container">
            <div class="row justify-content-center"> 
                ...
                <form class="formulario mt-5" method="POST" action="EmpleadoServlet">
                    <h1 style="color: white">EMPLEADO</h1>
                    <div class="mt-3">
                    ...
                    <button type="submit" name="accion" value="ingresarEmpleado" class="btn btn-primary">Submit</button>    
                  </form>
