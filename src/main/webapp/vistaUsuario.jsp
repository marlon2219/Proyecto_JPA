<%-- 
    Document   : newjsp
    Created on : 12 may. 2022, 20:43:01
    Author     : Pc
--%>
 ...
 <!-- **************************************HASTA AKI*********************************************************** -->
       ...
       <!-- FINAL DEL MODAL (SE PUEDE QUITAR SI FUNCION LAS DIRECCIONES DE LAS CARPETAS) -->
        ...
        <div class="container-fluid introduccion">
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <p class="text-center texto"><img class="imagenLogoPortada" src="img/recomendaciones.png" ><br>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>  
                </div>
            </div>
            <div class="row mt-5 ">
                    ...
                    <div class="container mx-auto box">
                        <div class="card " style="width: 25rem; margin: 10px auto; padding: 10px; ">
                            <div class="portadalibro">
                                <h2 style="color: whitesmoke">Cien años de soledad</h2>
                            </div>
                            <div class="card-body ">
                                <h5 class="card-title">Antonio Machado</h5>
                ...
                <div class="col-12 col-md-6  col-lg-4">
                    <div  class="container box">
                        <div class="card" style="width: 25rem;margin: 10px auto; padding: 10px;">
                            <div class="portadalibro">
                                <h2 style="color: whitesmoke">El señor de los anillos</h2>
                            </div>
                            <div class="card-body">
                ...
                <div  class="col-12 col-md-6 col-lg-4  ">
                    <div class="container box">
                        <div class="card" style=" width: 25rem;margin: 10px auto; padding: 10px; margin-bottom: 85px; ">
                            <div class="portadalibro">
