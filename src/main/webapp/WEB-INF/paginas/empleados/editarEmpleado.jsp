<html>
    ...
    <body>
        ...
        <div class="container mt-4">
          <form class="was-validate" action="ControladorEmpleados?accion=modificar&idCliente=7" method="POST">
              
                    <input type="hidden" name="ide"  class="form-control" id="exampleInputEmail1" value="${ideEmpleado}"  >
                    <div class="mb-3">
