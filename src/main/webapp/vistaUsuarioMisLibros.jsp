...
<html lang="en">
    ...
    <body>
        ...
        <!--BODY-->
        <table syle="" class="table text-center">
            <thead>
                <tr>
                    <th scope="col">#</th>
            ...
            <tbody>
                <c:forEach var="libro" items="${librosPorId}" varStatus="status">
                    ...
                    <tr>
                        ...
                        <td> <a href="LibroHasUsuariosServlet?accion=eliminarLibroHasUsuario&idLibro=${libro.getLibrosHasUsuariosPK().getIdLibro()}" class="btn btn-danger btn-block mt-1" >
